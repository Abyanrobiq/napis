...
<div class="bg-white rounded-2xl shadow-sm p-8 max-w-2xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Create New Saving Goal</h1>
        <p class="text-gray-500 text-sm mt-1">Set your financial target and start saving</p>
    </div>
    ...
    <form action="{{ route('savings.store') }}" method="POST" class="space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" name="current_amount" value="{{ old('current_amount', 0) }}" 
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
